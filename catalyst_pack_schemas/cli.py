...
class CLI:
    ...
    def _create_parser(self) -> argparse.ArgumentParser:
        ...
        rag_test_parser.add_argument("--index-sample", help="Sample document to index")
        rag_test_parser.add_argument("--search-query", help="Sample search query")
    ...
    def run(self, args: Optional[List[str]] = None) -> int:
        ...
        try:
            if parsed_args.command == "create":
                ...
                return self._handle_rag_command(parsed_args)
...
"""
    ...
    def _handle_rag_command(self, args) -> int:
        ...
        if args.rag_command == "init":
            ...
            return self._rag_validate(args)
        elif args.rag_command == "test":
            return self._rag_test(args)
        else:
  ...
  name: "{args.name}"
  version: "1.0.0"
  description: "RAG-enabled pack with {args.provider}"
  vendor: "Community"
  license: "MIT"
  compatibility: "1.0"
  domain: "rag"
...
tools:
  search_documents:
    type: "rag_search"
    description: "Search documents using visual understanding"
    parameters:
      - name: "query"
        type: "string"
        required: true
...
"""
            ...
            print("")
            print("Next steps:")
            print(f"1. Edit {pack_file} to customize your RAG configuration")
    ...
    def _rag_validate(self, args) -> int:
        ...
        try:
            ...
            if rag_config.qdrant_config:
                ...
                print(f"   Collection: {qc.collection_name}")
                print(f"   ColPali Model: {qc.colpali_model}")
